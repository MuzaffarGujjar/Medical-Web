        ...
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
            <div className='popup-form absolute mt-12 text-black'>
                <form className='w-80 md:w-96 space-y-5 bg-white p-5 rounded-xl'>
                    <h1 className='text-4xl font-semibold text-center text-backgroungColor'>Book Now</h1>
                    ...
                    <div className='flex gap-5'>
                        ...
                        <button className='bg-backgroungColor text-white px-10 rounded-md active:bg-red-500' onClick={closeForm}>Close</button>
                    </div>
                    <div>
